                  ...
                  <div className="card-body bg-white p-4">
                    <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                          ...
                          <div className="card h-100 border-0 shadow-sm rounded-3 overflow-hidden hover-shadow-lg transition-all">
                            ...
                            <div className="card-body pb-0">
                              <div className="d-flex gap-2 mb-2">
                                <span className="badge bg-info bg-opacity-10 text-info">{w.course.level}</span>
                                <span className="badge bg-success bg-opacity-10 text-success">{w.course.language}</span>
                              </div>
                              ...
                              <div className="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div className="text-warning small">
                                  <Rater
                                    ...
                                    interactive={false}
                                  />
                                  <span className="ms-1">({w.course.reviews?.length || 0})</span>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="card-footer bg-transparent border-0 pt-0 pb-3">
                              <div className="d-flex justify-content-between align-items-center">
                                <h5 className="mb-0 text-primary">${w.course.price || '0.00'}</h5>
                                <div>
                                  <button
                                    onClick={(e) => {
                                      e.preventDefault();
                      ...
                      {wishlist.length === 0 && !loading && (
                        <div className="card-body bg-white p-4 d-flex justify-content-center align-items-center" style={{ minHeight: "300px" }}>
